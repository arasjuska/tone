...
<div class="coupon" role="document">
    ...
    <p class="price">{{ __('Value') }}: <strong>{{ $invoice->buyer->price }} €</strong></p>
    <p class="expire">{{ __('Expires') }}: <strong>2025-03-21</strong></p>

    <div class="qr-code">
        @if($invoice->buyer->qr_code)
            <img src="data:image/png;base64,{{ $invoice->buyer->qr_code }}" alt="QR Code">
        @else
